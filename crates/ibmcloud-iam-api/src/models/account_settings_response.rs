...
impl AccountSettingsResponse {
    ...
    pub fn new(
        account_id: String,
        restrict_create_service_id: RestrictCreateServiceId,
        restrict_create_platform_apikey: RestrictCreatePlatformApikey,
        allowed_ip_addresses: String,
        entity_tag: String,
        mfa: Mfa,
        user_mfa: Vec<models::AccountSettingsUserMfa>,
