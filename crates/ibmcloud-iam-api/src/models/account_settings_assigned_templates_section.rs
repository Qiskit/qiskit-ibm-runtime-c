...
pub struct AccountSettingsAssignedTemplatesSection {
    /// Template Id
    ...
    #[serde(
        rename = "restrict_create_service_id",
    ...
    #[serde(
        rename = "restrict_create_platform_apikey",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    pub user_mfa: Option<Vec<models::EffectiveAccountSettingsUserMfa>>,
    ...
    #[serde(
        rename = "session_expiration_in_seconds",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "session_invalidation_in_seconds",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "max_sessions_per_identity",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "system_access_token_expiration_in_seconds",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "system_refresh_token_expiration_in_seconds",
        skip_serializing_if = "Option::is_none"
    )]
    pub system_refresh_token_expiration_in_seconds: Option<String>,
}

impl AccountSettingsAssignedTemplatesSection {
    pub fn new() -> AccountSettingsAssignedTemplatesSection {
