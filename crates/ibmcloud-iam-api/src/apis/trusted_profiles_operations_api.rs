...
pub async fn create_claim_rule(
    configuration: &configuration::Configuration,
    authorization: &str,
    profile_id: &str,
    profile_claim_rule_request: models::ProfileClaimRuleRequest,
) -> Result<models::ProfileClaimRule, Error<CreateClaimRuleError>> {
    ...
    let uri_str = format!(
        "{}/v1/profiles/{profile_id}/rules",
        configuration.base_path,
        profile_id = crate::apis::urlencode(p_profile_id)
    );
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ProfileClaimRule`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ProfileClaimRule`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn create_link(
    ...
    profile_id: &str,
    authorization: &str,
    create_profile_link_request: models::CreateProfileLinkRequest,
) -> Result<models::ProfileLink, Error<CreateLinkError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_profile_id = profile_id;
    let p_authorization = authorization;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ProfileLink`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ProfileLink`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn create_profile(
    configuration: &configuration::Configuration,
    authorization: &str,
    create_trusted_profile_request: models::CreateTrustedProfileRequest,
) -> Result<models::TrustedProfile, Error<CreateProfileError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_authorization = authorization;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::TrustedProfile`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::TrustedProfile`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn delete_claim_rule(
    configuration: &configuration::Configuration,
    profile_id: &str,
    rule_id: &str,
    authorization: &str,
) -> Result<(), Error<DeleteClaimRuleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_profile_id = profile_id;
    ...
    let uri_str = format!(
        "{}/v1/profiles/{profile_id}/rules/{rule_id}",
        configuration.base_path,
        profile_id = crate::apis::urlencode(p_profile_id),
        rule_id = crate::apis::urlencode(p_rule_id)
    );
    let mut req_builder = configuration
        .client
...
pub async fn delete_link(
    ...
    let uri_str = format!(
        "{}/v1/profiles/{profile_id}/links/{link_id}",
        configuration.base_path,
        profile_id = crate::apis::urlencode(p_profile_id),
        link_id = crate::apis::urlencode(p_link_id)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
...
pub async fn delete_profile_identity(
    configuration: &configuration::Configuration,
    profile_id: &str,
    identity_type: &str,
    identifier_id: &str,
    authorization: &str,
) -> Result<(), Error<DeleteProfileIdentityError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_profile_id = profile_id;
    ...
    let uri_str = format!(
        "{}/v1/profiles/{profile_id}/identities/{identity_type}/{identifier_id}",
        configuration.base_path,
        profile_id = crate::apis::urlencode(p_profile_id),
        identity_type = crate::apis::urlencode(p_identity_type),
        identifier_id = crate::apis::urlencode(p_identifier_id)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
...
pub async fn get_claim_rule(
    configuration: &configuration::Configuration,
    profile_id: &str,
    rule_id: &str,
    authorization: &str,
) -> Result<models::ProfileClaimRule, Error<GetClaimRuleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_profile_id = profile_id;
    let p_rule_id = rule_id;
    let p_authorization = authorization;
...
pub async fn get_link(
    ...
    link_id: &str,
    authorization: &str,
) -> Result<models::ProfileLink, Error<GetLinkError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_profile_id = profile_id;
    let p_link_id = link_id;
    let p_authorization = authorization;
...
) -> Result<models::TrustedProfile, Error<GetProfileError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_profile_id = profile_id;
    let p_authorization = authorization;
...
pub async fn get_profile_identities(
    configuration: &configuration::Configuration,
    profile_id: &str,
    authorization: &str,
) -> Result<models::ProfileIdentitiesResponse, Error<GetProfileIdentitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_profile_id = profile_id;
    let p_authorization = authorization;

    let uri_str = format!(
        "{}/v1/profiles/{profile_id}/identities",
        configuration.base_path,
        profile_id = crate::apis::urlencode(p_profile_id)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ProfileIdentitiesResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ProfileIdentitiesResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_profile_identity(
    ...
    identifier_id: &str,
    authorization: &str,
) -> Result<models::ProfileIdentityResponse, Error<GetProfileIdentityError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_profile_id = profile_id;
    let p_identity_type = identity_type;
    let p_identifier_id = identifier_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ProfileIdentityResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ProfileIdentityResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn list_claim_rules(
    configuration: &configuration::Configuration,
    profile_id: &str,
    authorization: &str,
) -> Result<models::ProfileClaimRuleList, Error<ListClaimRulesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_profile_id = profile_id;
    let p_authorization = authorization;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ProfileClaimRuleList`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ProfileClaimRuleList`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn list_links(
    ...
    profile_id: &str,
    authorization: &str,
) -> Result<models::ProfileLinkList, Error<ListLinksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_profile_id = profile_id;
    let p_authorization = authorization;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ProfileLinkList`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ProfileLinkList`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn list_profiles(
    ...
    filter: Option<&str>,
) -> Result<models::TrustedProfilesList, Error<ListProfilesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::TrustedProfilesList`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::TrustedProfilesList`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn set_profile_identities(
    configuration: &configuration::Configuration,
    profile_id: &str,
    if_match: &str,
    authorization: &str,
    profile_identities_update_request: models::ProfileIdentitiesUpdateRequest,
) -> Result<models::ProfileIdentitiesResponse, Error<SetProfileIdentitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_profile_id = profile_id;
...
pub async fn set_profile_identity(
    configuration: &configuration::Configuration,
    profile_id: &str,
    identity_type: &str,
    authorization: &str,
    profile_identity_request: models::ProfileIdentityRequest,
) -> Result<models::ProfileIdentityResponse, Error<SetProfileIdentityError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_profile_id = profile_id;
    let p_identity_type = identity_type;
    let p_authorization = authorization;
    ...
    let uri_str = format!(
        "{}/v1/profiles/{profile_id}/identities/{identity_type}",
        configuration.base_path,
        profile_id = crate::apis::urlencode(p_profile_id),
        identity_type = crate::apis::urlencode(p_identity_type)
    );
...
pub async fn update_claim_rule(
    configuration: &configuration::Configuration,
    profile_id: &str,
    rule_id: &str,
    authorization: &str,
    if_match: &str,
    profile_claim_rule_request: models::ProfileClaimRuleRequest,
) -> Result<models::ProfileClaimRule, Error<UpdateClaimRuleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_profile_id = profile_id;
    let p_rule_id = rule_id;
    let p_authorization = authorization;
...
pub async fn update_profile(
    ...
    authorization: &str,
    if_match: &str,
    update_trusted_profile_request: models::UpdateTrustedProfileRequest,
) -> Result<models::TrustedProfile, Error<UpdateProfileError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_profile_id = profile_id;
    let p_authorization = authorization;
    let p_if_match = if_match;
