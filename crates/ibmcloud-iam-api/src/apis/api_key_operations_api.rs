...
pub async fn create_api_key(
    ...
    entity_disable: Option<&str>,
) -> Result<models::ApiKey, Error<CreateApiKeyError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ApiKey`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ApiKey`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn disable_api_key(
    ...
    id: &str,
    authorization: &str,
) -> Result<(), Error<DisableApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_authorization = authorization;
...
pub async fn enable_api_key(
    ...
    id: &str,
    authorization: &str,
) -> Result<(), Error<EnableApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_authorization = authorization;
...
pub async fn get_api_keys_details(
    configuration: &configuration::Configuration,
    authorization: &str,
    iam_api_key: Option<&str>,
    include_history: Option<bool>,
) -> Result<models::ApiKey, Error<GetApiKeysDetailsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_authorization = authorization;
...
pub async fn list_api_keys(
    ...
    include_history: Option<bool>,
    filter: Option<&str>,
) -> Result<models::ApiKeyList, Error<ListApiKeysError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_authorization = authorization;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ApiKeyList`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ApiKeyList`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn lock_api_key(
    configuration: &configuration::Configuration,
    id: &str,
    authorization: &str,
) -> Result<(), Error<LockApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_authorization = authorization;
...
pub async fn unlock_api_key(
    configuration: &configuration::Configuration,
    id: &str,
    authorization: &str,
) -> Result<(), Error<UnlockApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_authorization = authorization;
...
) -> Result<models::ApiKey, Error<UpdateApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
