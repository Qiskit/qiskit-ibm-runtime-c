...
pub fn create_estimator_job_payload(
    ...
    runtime: Option<String>,
    tags: Option<Vec<String>>,
    resilience_level: Option<ibm_quantum_platform_api::models::estimator_v2_input::ResilienceLevel>,
    precision: Option<f64>
) -> ibm_quantum_platform_api::models::CreateJobRequestOneOf {
    let pubs = generate_single_pubs_payload(circuit);
    let sampler_input = ibm_quantum_platform_api::models::EstimatorV2Input {
