...
/// AggregateResult : The resources aggregate response
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AggregateResult {
    #[serde(rename = "aggregation")]
    pub aggregation: Box<models::TermsAggregationResult>,
}

impl AggregateResult {
    /// The resources aggregate response
    pub fn new(aggregation: models::TermsAggregationResult) -> AggregateResult {
        AggregateResult {
