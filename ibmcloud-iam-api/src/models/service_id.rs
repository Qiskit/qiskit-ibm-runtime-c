...
impl ServiceId {
    ...
    pub fn new(id: String, iam_id: String, entity_tag: String, crn: String, locked: bool, created_at: String, modified_at: String, account_id: String, name: String) -> ServiceId {
        ServiceId {
            context: None,
            id,
            iam_id,
