...
impl TemplateAssignmentResponse {
    ...
    pub fn new(id: String, account_id: String, template_id: String, template_version: i64, target_type: String, target: String, status: String, created_at: String, created_by_id: String, last_modified_at: String, last_modified_by_id: String, entity_tag: String) -> TemplateAssignmentResponse {
