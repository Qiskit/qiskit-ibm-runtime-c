...
impl AccountBasedMfaEnrollment {
    pub fn new(security_questions: models::MfaEnrollmentTypeStatus, totp: models::MfaEnrollmentTypeStatus, verisign: models::MfaEnrollmentTypeStatus, complies: bool) -> AccountBasedMfaEnrollment {
