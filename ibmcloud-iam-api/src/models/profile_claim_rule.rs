...
impl ProfileClaimRule {
    pub fn new(id: String, entity_tag: String, created_at: String, r#type: String, expiration: i32, conditions: Vec<models::ProfileClaimRuleConditions>) -> ProfileClaimRule {
        ProfileClaimRule {
            id,
            entity_tag,
            created_at,
