...
pub struct AccountSettingsTemplateList {
    ...
    #[serde(rename = "account_settings_templates")]
    pub account_settings_templates: Vec<models::AccountSettingsTemplateResponse>,
}

impl AccountSettingsTemplateList {
    pub fn new(account_settings_templates: Vec<models::AccountSettingsTemplateResponse>) -> AccountSettingsTemplateList {
