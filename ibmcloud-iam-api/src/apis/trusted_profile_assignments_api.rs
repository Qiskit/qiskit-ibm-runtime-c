...
pub async fn create_trusted_profile_assignment(configuration: &configuration::Configuration, create_template_assignment_request: models::CreateTemplateAssignmentRequest, authorization: Option<&str>) -> Result<models::TemplateAssignmentResponse, Error<CreateTrustedProfileAssignmentError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateTrustedProfileAssignmentError> = serde_json::from_str(&content).ok();
...
pub async fn delete_trusted_profile_assignment(configuration: &configuration::Configuration, assignment_id: &str, authorization: Option<&str>) -> Result<models::ExceptionResponse, Error<DeleteTrustedProfileAssignmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_assignment_id = assignment_id;
    let p_authorization = authorization;

    let uri_str = format!("{}/v1/profile_assignments/{assignment_id}", configuration.base_path, assignment_id=crate::apis::urlencode(p_assignment_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteTrustedProfileAssignmentError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Get an assigment for a trusted profile template.
pub async fn get_trusted_profile_assignment(configuration: &configuration::Configuration, assignment_id: &str, include_history: Option<bool>, authorization: Option<&str>) -> Result<models::TemplateAssignmentResponse, Error<GetTrustedProfileAssignmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_assignment_id = assignment_id;
...
pub async fn list_trusted_profile_assignments(configuration: &configuration::Configuration, account_id: Option<&str>, template_id: Option<&str>, template_version: Option<&str>, target: Option<&str>, target_type: Option<&str>, limit: Option<i32>, pagetoken: Option<&str>, sort: Option<&str>, order: Option<&str>, include_history: Option<bool>, authorization: Option<&str>) -> Result<models::TemplateAssignmentListResponse, Error<ListTrustedProfileAssignmentsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListTrustedProfileAssignmentsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn update_trusted_profile_assignment(configuration: &configuration::Configuration, assignment_id: &str, if_match: &str, update_template_assignment_request: models::UpdateTemplateAssignmentRequest, authorization: Option<&str>) -> Result<models::TemplateAssignmentResponse, Error<UpdateTrustedProfileAssignmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_assignment_id = assignment_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateTrustedProfileAssignmentError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
