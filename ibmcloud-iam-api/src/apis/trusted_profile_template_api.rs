...
pub async fn commit_profile_template(configuration: &configuration::Configuration, template_id: &str, version: &str, authorization: &str) -> Result<(), Error<CommitProfileTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_template_id = template_id;
    let p_version = version;
    let p_authorization = authorization;

    let uri_str = format!("{}/v1/profile_templates/{template_id}/versions/{version}/commit", configuration.base_path, template_id=crate::apis::urlencode(p_template_id), version=crate::apis::urlencode(p_version));
...
pub async fn create_profile_template(configuration: &configuration::Configuration, authorization: &str, trusted_profile_template_request: models::TrustedProfileTemplateRequest) -> Result<models::TrustedProfileTemplateResponse, Error<CreateProfileTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_authorization = authorization;
...
pub async fn create_profile_template_version(configuration: &configuration::Configuration, template_id: &str, authorization: &str, trusted_profile_template_request: models::TrustedProfileTemplateRequest) -> Result<models::TrustedProfileTemplateResponse, Error<CreateProfileTemplateVersionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_template_id = template_id;
    let p_authorization = authorization;
    let p_trusted_profile_template_request = trusted_profile_template_request;

    let uri_str = format!("{}/v1/profile_templates/{template_id}/versions", configuration.base_path, template_id=crate::apis::urlencode(p_template_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn delete_all_versions_of_profile_template(configuration: &configuration::Configuration, template_id: &str, authorization: &str) -> Result<(), Error<DeleteAllVersionsOfProfileTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_template_id = template_id;
    let p_authorization = authorization;

    let uri_str = format!("{}/v1/profile_templates/{template_id}", configuration.base_path, template_id=crate::apis::urlencode(p_template_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteAllVersionsOfProfileTemplateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn delete_profile_template_version(configuration: &configuration::Configuration, template_id: &str, version: &str, authorization: &str) -> Result<(), Error<DeleteProfileTemplateVersionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_template_id = template_id;
    let p_version = version;
    let p_authorization = authorization;

    let uri_str = format!("{}/v1/profile_templates/{template_id}/versions/{version}", configuration.base_path, template_id=crate::apis::urlencode(p_template_id), version=crate::apis::urlencode(p_version));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn get_latest_profile_template_version(configuration: &configuration::Configuration, template_id: &str, authorization: &str, include_history: Option<bool>) -> Result<models::TrustedProfileTemplateResponse, Error<GetLatestProfileTemplateVersionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_template_id = template_id;
    let p_authorization = authorization;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetLatestProfileTemplateVersionError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Get a specific version of a trusted profile template in an enterprise account.
pub async fn get_profile_template_version(configuration: &configuration::Configuration, template_id: &str, version: &str, authorization: &str, include_history: Option<bool>) -> Result<models::TrustedProfileTemplateResponse, Error<GetProfileTemplateVersionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_template_id = template_id;
    let p_version = version;
    let p_authorization = authorization;
...
pub async fn list_profile_templates(configuration: &configuration::Configuration, authorization: &str, account_id: Option<&str>, limit: Option<&str>, pagetoken: Option<&str>, sort: Option<&str>, order: Option<&str>, include_history: Option<&str>) -> Result<models::TrustedProfileTemplateList, Error<ListProfileTemplatesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_authorization = authorization;
...
pub async fn list_versions_of_profile_template(configuration: &configuration::Configuration, template_id: &str, authorization: &str, limit: Option<&str>, pagetoken: Option<&str>, sort: Option<&str>, order: Option<&str>, include_history: Option<&str>) -> Result<models::TrustedProfileTemplateList, Error<ListVersionsOfProfileTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_template_id = template_id;
    let p_authorization = authorization;
    let p_limit = limit;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListVersionsOfProfileTemplateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Update a specific version of a trusted profile template in an enterprise account.
pub async fn update_profile_template_version(configuration: &configuration::Configuration, if_match: &str, template_id: &str, version: &str, authorization: &str, trusted_profile_template_request: models::TrustedProfileTemplateRequest) -> Result<models::TrustedProfileTemplateResponse, Error<UpdateProfileTemplateVersionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
