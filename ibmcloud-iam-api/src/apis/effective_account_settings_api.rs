...
pub async fn get_effective_account_settings(configuration: &configuration::Configuration, account_id: &str, authorization: &str, include_history: Option<bool>, resolve_user_mfa: Option<bool>) -> Result<models::EffectiveAccountSettingsResponse, Error<GetEffectiveAccountSettingsError>> {
    ...
    let uri_str = format!("{}/v1/accounts/{account_id}/effective_settings/identity", configuration.base_path, account_id=crate::apis::urlencode(p_account_id));
