...
pub async fn delete_preferences_on_scope_account(configuration: &configuration::Configuration, account_id: &str, iam_id: &str, service: &str, preference_id: &str, authorization: Option<&str>) -> Result<models::ExceptionResponse, Error<DeletePreferencesOnScopeAccountError>> {
    ...
    let uri_str = format!("{}/v1/preferences/accounts/{account_id}/identities/{iam_id}/{service}/{preference_id}", configuration.base_path, account_id=crate::apis::urlencode(p_account_id), iam_id=crate::apis::urlencode(p_iam_id), service=crate::apis::urlencode(p_service), preference_id=crate::apis::urlencode(p_preference_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeletePreferencesOnScopeAccountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Get all Identity Preferences for one account / user combination.
pub async fn get_all_preferences_on_scope_account(configuration: &configuration::Configuration, account_id: &str, iam_id: &str, authorization: Option<&str>) -> Result<models::IdentityPreferencesResponse, Error<GetAllPreferencesOnScopeAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_account_id = account_id;
    let p_iam_id = iam_id;
    let p_authorization = authorization;

    let uri_str = format!("{}/v1/preferences/accounts/{account_id}/identities/{iam_id}", configuration.base_path, account_id=crate::apis::urlencode(p_account_id), iam_id=crate::apis::urlencode(p_iam_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetAllPreferencesOnScopeAccountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Get one Identity Preference on scope 'account'.
pub async fn get_preferences_on_scope_account(configuration: &configuration::Configuration, account_id: &str, iam_id: &str, service: &str, preference_id: &str, authorization: Option<&str>) -> Result<models::IdentityPreferenceResponse, Error<GetPreferencesOnScopeAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_account_id = account_id;
    let p_iam_id = iam_id;
    let p_service = service;
...
pub async fn update_preference_on_scope_account(configuration: &configuration::Configuration, account_id: &str, iam_id: &str, service: &str, preference_id: &str, update_preference_request: models::UpdatePreferenceRequest, authorization: Option<&str>) -> Result<models::IdentityPreferenceResponse, Error<UpdatePreferenceOnScopeAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_account_id = account_id;
    let p_iam_id = iam_id;
    let p_service = service;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdatePreferenceOnScopeAccountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
