...
pub async fn create_account_settings_assignment(configuration: &configuration::Configuration, create_template_assignment_request: models::CreateTemplateAssignmentRequest, authorization: Option<&str>) -> Result<models::TemplateAssignmentResponse, Error<CreateAccountSettingsAssignmentError>> {
    ...
    let uri_str = format!("{}/v1/account_settings_assignments/", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateAccountSettingsAssignmentError> = serde_json::from_str(&content).ok();
...
pub async fn delete_account_settings_assignment(configuration: &configuration::Configuration, assignment_id: &str, authorization: Option<&str>) -> Result<models::ExceptionResponse, Error<DeleteAccountSettingsAssignmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_assignment_id = assignment_id;
    let p_authorization = authorization;

    let uri_str = format!("{}/v1/account_settings_assignments/{assignment_id}", configuration.base_path, assignment_id=crate::apis::urlencode(p_assignment_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteAccountSettingsAssignmentError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Get an assigment for an account settings template.
pub async fn get_account_settings_assignment(configuration: &configuration::Configuration, assignment_id: &str, include_history: Option<bool>, authorization: Option<&str>) -> Result<models::TemplateAssignmentResponse, Error<GetAccountSettingsAssignmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_assignment_id = assignment_id;
...
pub async fn list_account_settings_assignments(configuration: &configuration::Configuration, account_id: Option<&str>, template_id: Option<&str>, template_version: Option<&str>, target: Option<&str>, target_type: Option<&str>, limit: Option<i32>, pagetoken: Option<&str>, sort: Option<&str>, order: Option<&str>, include_history: Option<bool>, authorization: Option<&str>) -> Result<models::TemplateAssignmentListResponse, Error<ListAccountSettingsAssignmentsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListAccountSettingsAssignmentsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn update_account_settings_assignment(configuration: &configuration::Configuration, assignment_id: &str, if_match: &str, update_template_assignment_request: models::UpdateTemplateAssignmentRequest, authorization: Option<&str>) -> Result<models::TemplateAssignmentResponse, Error<UpdateAccountSettingsAssignmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_assignment_id = assignment_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateAccountSettingsAssignmentError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
