...
/// CatalogCategories : The Global catalog categories, subcategories, and services
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CatalogCategories {
    /// The array of Global catalog categories.
    #[serde(rename = "categories")]
    pub categories: Vec<models::CatalogCategory>,
}

impl CatalogCategories {
    /// The Global catalog categories, subcategories, and services
    pub fn new(categories: Vec<models::CatalogCategory>) -> CatalogCategories {
