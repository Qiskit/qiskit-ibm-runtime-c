...
pub struct EstimatorV2InputOptionsResilienceLayerNoiseLearning {
    ...
    #[serde(rename = "max_layers_to_learn", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub max_layers_to_learn: Option<Option<i32>>,
    /// The total number of shots to use per random learning circuit
    #[serde(rename = "shots_per_randomization", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "layer_pair_depths", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
