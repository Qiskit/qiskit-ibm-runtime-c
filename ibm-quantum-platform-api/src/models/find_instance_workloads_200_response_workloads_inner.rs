...
pub struct FindInstanceWorkloads200ResponseWorkloadsInner {
    ...
    #[serde(rename = "accepting_jobs", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl FindInstanceWorkloads200ResponseWorkloadsInner {
    pub fn new(id: String, created: String, backend: String, instance: String, user_id: String, mode: Mode, status: Status) -> FindInstanceWorkloads200ResponseWorkloadsInner {
