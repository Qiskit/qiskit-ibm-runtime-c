...
pub struct GetUsage200Response {
    ...
    #[serde(rename = "usage_limit_seconds", skip_serializing_if = "Option::is_none")]
    pub usage_limit_seconds: Option<f64>,
    /// The seconds that are allocated for the instance during the usage period
    #[serde(rename = "usage_allocation_seconds", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "usage_limit_reached", skip_serializing_if = "Option::is_none")]
    pub usage_limit_reached: Option<bool>,
}

impl GetUsage200Response {
    pub fn new(instance_id: String, plan_id: String, usage_consumed_seconds: f64) -> GetUsage200Response {
        GetUsage200Response {
            instance_id,
            plan_id,
            usage_period: None,
