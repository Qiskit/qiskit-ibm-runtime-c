...
pub struct JobResponseRemoteStorage {
    ...
    #[serde(rename = "transpiled_circuits", skip_serializing_if = "Option::is_none")]
    pub transpiled_circuits: Option<Box<models::RemoteStorageTranspiledCircuits>>,
}

impl JobResponseRemoteStorage {
    pub fn new(region: String, region_type: RegionType, bucket_crn: String, object_name: String, job_params: models::RemoteStorageJobParams, results: models::RemoteStorageResults) -> JobResponseRemoteStorage {
