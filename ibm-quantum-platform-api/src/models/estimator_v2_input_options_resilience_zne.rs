...
pub struct EstimatorV2InputOptionsResilienceZne {
    ...
    #[serde(rename = "noise_factors", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "extrapolated_noise_factors", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
