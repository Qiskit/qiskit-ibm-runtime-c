...
pub async fn find_instance_workloads(configuration: &configuration::Configuration, ibm_api_version: Option<&str>, sort: Option<&str>, limit: Option<f64>, previous: Option<&str>, next: Option<&str>, backend: Option<&str>, search: Option<&str>, status: Option<Vec<String>>, mode: Option<&str>, created_after: Option<String>, created_before: Option<String>, tags: Option<Vec<String>>) -> Result<models::FindInstanceWorkloads200Response, Error<FindInstanceWorkloadsError>> {
