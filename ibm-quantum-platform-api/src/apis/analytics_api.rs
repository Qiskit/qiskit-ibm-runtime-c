...
pub async fn analytics_filters(configuration: &configuration::Configuration, ibm_api_version: Option<&str>, instance: Option<Vec<String>>) -> Result<models::AnalyticsFilters200Response, Error<AnalyticsFiltersError>> {
    ...
    if let Some(ref param_value) = p_instance {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("instance".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("instance", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
...
/// Get usage analytics
pub async fn analytics_usage(configuration: &configuration::Configuration, ibm_api_version: Option<&str>, instance: Option<Vec<String>>, interval_start: Option<String>, interval_end: Option<String>, backend: Option<Vec<String>>, user_id: Option<Vec<String>>, simulators: Option<bool>, plan: Option<Vec<String>>) -> Result<models::AnalyticsUsage200Response, Error<AnalyticsUsageError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ibm_api_version = ibm_api_version;
    let p_instance = instance;
    ...
    if let Some(ref param_value) = p_backend {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("backend".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("backend", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref param_value) = p_plan {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("plan".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("plan", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
...
pub async fn get_usage_analytics_grouped(configuration: &configuration::Configuration, group_by: &str, ibm_api_version: Option<&str>, instance: Option<Vec<String>>, interval_start: Option<String>, interval_end: Option<String>, backend: Option<Vec<String>>, user_id: Option<Vec<String>>, simulators: Option<bool>, plan: Option<Vec<String>>) -> Result<models::GetUsageAnalyticsGrouped200Response, Error<GetUsageAnalyticsGroupedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_usage_analytics_grouped_by_date(configuration: &configuration::Configuration, group_by: &str, ibm_api_version: Option<&str>, instance: Option<Vec<String>>, interval_start: Option<String>, interval_end: Option<String>, backend: Option<Vec<String>>, user_id: Option<Vec<String>>, simulators: Option<bool>, plan: Option<Vec<String>>) -> Result<models::GetUsageAnalyticsGroupedByDate200Response, Error<GetUsageAnalyticsGroupedByDateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_group_by = group_by;
    let p_ibm_api_version = ibm_api_version;
    let p_instance = instance;
    ...
    let uri_str = format!("{}/v1/analytics/usage_grouped_by_date", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetUsageAnalyticsGroupedByDateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
