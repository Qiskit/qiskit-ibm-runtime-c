...
pub async fn get_instance(configuration: &configuration::Configuration, ibm_api_version: Option<&str>) -> Result<models::GetInstance200Response, Error<GetInstanceError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetInstance200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetInstance200Response`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_instance_configuration(configuration: &configuration::Configuration, ibm_api_version: Option<&str>) -> Result<models::GetInstanceConfiguration200Response, Error<GetInstanceConfigurationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ibm_api_version = ibm_api_version;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetInstanceConfiguration200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetInstanceConfiguration200Response`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// Get instance usage
pub async fn get_usage(configuration: &configuration::Configuration, ibm_api_version: Option<&str>) -> Result<models::GetUsage200Response, Error<GetUsageError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ibm_api_version = ibm_api_version;
...
pub async fn replace_instance_data(configuration: &configuration::Configuration, ibm_api_version: Option<&str>, instance_update: Option<models::ReplaceInstanceDataRequest>) -> Result<(), Error<ReplaceInstanceDataError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ibm_api_version = ibm_api_version;
