...
pub async fn cancel_job_jid(configuration: &configuration::Configuration, id: &str, parent_job_id: Option<&str>, ibm_api_version: Option<&str>) -> Result<(), Error<CancelJobJidError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_parent_job_id = parent_job_id;
    let p_ibm_api_version = ibm_api_version;

    let uri_str = format!("{}/v1/jobs/{id}/cancel", configuration.base_path, id=crate::apis::urlencode(p_id));
...
pub async fn create_job(configuration: &configuration::Configuration, ibm_api_version: Option<&str>, parent_job_id: Option<&str>, create_job_request: Option<models::CreateJobRequest>) -> Result<models::CreateJob200Response, Error<CreateJobError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ibm_api_version = ibm_api_version;
    let p_parent_job_id = parent_job_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::CreateJob200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::CreateJob200Response`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn delete_job_jid(configuration: &configuration::Configuration, id: &str, ibm_api_version: Option<&str>) -> Result<(), Error<DeleteJobJidError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_ibm_api_version = ibm_api_version;

    let uri_str = format!("{}/v1/jobs/{id}", configuration.base_path, id=crate::apis::urlencode(p_id));
...
pub async fn get_interim_results_jid(configuration: &configuration::Configuration, id: &str, ibm_api_version: Option<&str>) -> Result<String, Error<GetInterimResultsJidError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_ibm_api_version = ibm_api_version;

    let uri_str = format!("{}/v1/jobs/{id}/interim_results", configuration.base_path, id=crate::apis::urlencode(p_id));
...
pub async fn get_job_details_jid(configuration: &configuration::Configuration, id: &str, ibm_api_version: Option<&str>, exclude_params: Option<bool>) -> Result<models::JobResponse, Error<GetJobDetailsJidError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_ibm_api_version = ibm_api_version;
...
pub async fn get_job_metrics_jid(configuration: &configuration::Configuration, id: &str, ibm_api_version: Option<&str>) -> Result<models::JobMetrics, Error<GetJobMetricsJidError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_ibm_api_version = ibm_api_version;

    let uri_str = format!("{}/v1/jobs/{id}/metrics", configuration.base_path, id=crate::apis::urlencode(p_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::JobMetrics`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::JobMetrics`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_job_results_jid(configuration: &configuration::Configuration, id: &str, ibm_api_version: Option<&str>) -> Result<String, Error<GetJobResultsJidError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_ibm_api_version = ibm_api_version;

    let uri_str = format!("{}/v1/jobs/{id}/results", configuration.base_path, id=crate::apis::urlencode(p_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_jog_logs_jid(configuration: &configuration::Configuration, id: &str, ibm_api_version: Option<&str>) -> Result<String, Error<GetJogLogsJidError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_ibm_api_version = ibm_api_version;

    let uri_str = format!("{}/v1/jobs/{id}/logs", configuration.base_path, id=crate::apis::urlencode(p_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_transpiled_circuits_jid(configuration: &configuration::Configuration, id: &str, ibm_api_version: Option<&str>) -> Result<models::JobsTranspiledCircuitsResponse, Error<GetTranspiledCircuitsJidError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_ibm_api_version = ibm_api_version;

    let uri_str = format!("{}/v1/jobs/{id}/transpiled_circuits", configuration.base_path, id=crate::apis::urlencode(p_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::JobsTranspiledCircuitsResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::JobsTranspiledCircuitsResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn list_jobs(configuration: &configuration::Configuration, ibm_api_version: Option<&str>, limit: Option<i32>, offset: Option<i32>, pending: Option<bool>, program: Option<&str>, backend: Option<&str>, created_after: Option<String>, created_before: Option<String>, sort: Option<&str>, tags: Option<Vec<String>>, session_id: Option<&str>, exclude_params: Option<bool>) -> Result<models::JobsResponse, Error<ListJobsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ibm_api_version = ibm_api_version;
    let p_limit = limit;
    let p_offset = offset;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::JobsResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::JobsResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// Replace job tags
pub async fn replace_job_tags(configuration: &configuration::Configuration, id: &str, ibm_api_version: Option<&str>, replace_job_tags_request: Option<models::ReplaceJobTagsRequest>) -> Result<(), Error<ReplaceJobTagsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_ibm_api_version = ibm_api_version;
    let p_replace_job_tags_request = replace_job_tags_request;

    let uri_str = format!("{}/v1/jobs/{id}/tags", configuration.base_path, id=crate::apis::urlencode(p_id));
